...
exports.CodegenConfigSchema = exports.GenerateModeEnum = exports.GenerateTypeEnum = void 0;
const zod_1 = require("zod");
var GenerateTypeEnum;
(function (GenerateTypeEnum) {
    GenerateTypeEnum["Seperate"] = "seperate";
    GenerateTypeEnum["Combine"] = "combine";
...
exports.CodegenConfigSchema = zod_1.z.object({
    generateType: zod_1.z.nativeEnum(GenerateTypeEnum).default(GenerateTypeEnum.Seperate),
