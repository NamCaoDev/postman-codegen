...
export declare const replaceTypeDuplicateString: (content: string) => string;
export declare function fixDuplicateInterfacesBetweenStrings(baseContent: any, newContent: any, entityName: any): any;
